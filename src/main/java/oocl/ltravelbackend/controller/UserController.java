...
public class UserController {
  ...
  @GetMapping("/like-status/{planId}")
  public ResponseEntity<Boolean> checkFavoriteStatus(@PathVariable Long planId,@RequestParam Long userId) {
    return ResponseEntity.status(HttpStatus.OK).body(userService.getLikeStatus(planId,userId));
  }
