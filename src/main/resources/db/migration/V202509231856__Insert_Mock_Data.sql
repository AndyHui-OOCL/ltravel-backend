-- travel_plan
INSERT INTO travel_plan (id, city_name, description, is_local_travel, is_popular, title)
VALUES (1, '北京',
...
-- travel_component
INSERT INTO travel_components (address, current_occupation, description, future_occupation, is_location, name,
...
-- plan_images
INSERT INTO plan_images (name, travel_plan_id, url)
...
-- travel_days
INSERT INTO travel_days (component_order, day_num, travel_component_id, travel_plan_id)
...
-- comments
INSERT INTO comment (description, is_like, travel_component_id, user_id)
VALUES ('香山的红叶太美了，拍了很多照片！', true, 1, 1),
       ('故宫人很多，但历史气息很浓，值得一看。', true, 2, 2),
       ('苏堤傍晚散步非常舒服，推荐租个自行车环湖。', true, 3, 3),
       ('灵隐寺香火旺盛，建议早上前往避开人流。',false, 4, 1),
       ('颐和园景色优美，长廊很适合拍照。', false, 5, 2);

-- official_comments
INSERT INTO official_comment (event_comment, overall_comment, promote_reason, rating, travel_plan_id)
